...
(function (global, factory) {
  ...
  Parsley.addMessages('en', {
    ...
    type: {
      email: "Cette doit etre un valide email.",
      url: "This value should be a valid url.",
      number: "Cette valeur doit etre un nombre.",
      integer: "Cette valeur doit etre un nombre.",
      digits: "Cette valeur doit etre des nombres.",
      alphanum: "Cette valeur doit etre des lettres."
    },
    notblank: "Cette valeur ne peut pas etre vide.",
    required: "Cette valeur est requise.",
    pattern: "Cette value est invalide.",
    min: "This value should be greater than or equal to %s.",
    max: "This value should be lower than or equal to %s.",
    range: "Cette valeur doit etre entre %s and %s.",
    minlength: "Tros courte. il doit avoir %s characteres ou plus.",
